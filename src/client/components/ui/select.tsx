  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        ...
        'text-sm shadow-soft transition-[border-color,box-shadow] duration-150',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        position={position}
        className={cn(
          'relative z-50 max-h-72 min-w-32 overflow-hidden rounded-lg border border-border bg-popover',
          'text-popover-foreground shadow-raised',
